...
// mssql settings
$MsSql_server = 'stagingdb.wilsonelectronics.com';
$MsSql_databasename = 'weBoostAppV2';
$MsSql_WindowsAuthentication = false;   //true or false
$MsSql_username = 'WilsonWebSvc';          //not used if MsSql_WindowsAuthentication is true
$MsSql_password = 'bU_tJ-pCK29hr7a!';          //not used if MsSql_WindowsAuthentication is true
